...
<html>
    <head>
        ...
        <!-- Le styles -->
        <link href="/wap.weifengtou.com/web/weiphp/Public/static/bootstrap/css/bootstrap.css?v=<?php echo SITE_VERSION;?>" rel="stylesheet">
        <link href="/wap.weifengtou.com/web/weiphp/Public/static/bootstrap/css/bootstrap-responsive.css?v=<?php echo SITE_VERSION;?>" rel="stylesheet">
        <link href="/wap.weifengtou.com/web/weiphp/Public/Install/css/install.css?v=<?php echo SITE_VERSION;?>" rel="stylesheet">

        <!-- Le HTML5 shim, for IE6-8 support of HTML5 elements -->
        <!--[if lt IE 9]>
            <script src="assets/js/html5shiv.js?v=<?php echo SITE_VERSION;?>"></script>
        <![endif]-->
        <script src="/wap.weifengtou.com/web/weiphp/Public/static/jquery-1.10.2.min.js"></script>
        <script src="/wap.weifengtou.com/web/weiphp/Public/static/bootstrap/js/bootstrap.js?v=<?php echo SITE_VERSION;?>"></script>
    </head>
 ...
 defined('SAE_MYSQL_HOST_M') or define('SAE_MYSQL_HOST_M', '127.0.0.1'); defined('SAE_MYSQL_HOST_M') or define('SAE_MYSQL_PORT', '3306'); ?>
    <h1>创建数据库</h1>
    <form action="/wap.weifengtou.com/web/weiphp/install.php?m=Install&c=Install&a=step2" method="post" target="_self">
