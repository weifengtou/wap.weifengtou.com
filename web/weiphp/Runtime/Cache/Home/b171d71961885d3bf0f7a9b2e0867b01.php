...
<link href="/wap.weifengtou.com/web/weiphp/Public/static/font-awesome/css/font-awesome.min.css?v=<?php echo SITE_VERSION;?>" rel="stylesheet">
<link href="/wap.weifengtou.com/web/weiphp/Public/Home/css/base.css?v=<?php echo SITE_VERSION;?>" rel="stylesheet">
<link href="/wap.weifengtou.com/web/weiphp/Public/Home/css/module.css?v=<?php echo SITE_VERSION;?>" rel="stylesheet">
<link href="/wap.weifengtou.com/web/weiphp/Public/Home/css/weiphp.css?v=<?php echo SITE_VERSION;?>" rel="stylesheet">
<!-- Le HTML5 shim, for IE6-8 support of HTML5 elements -->
<!--[if lt IE 9]>
<script src="/wap.weifengtou.com/web/weiphp/Public/static/bootstrap/js/html5shiv.js?v=<?php echo SITE_VERSION;?>"></script>
<![endif]-->

<!--[if lt IE 9]>
<script type="text/javascript" src="/wap.weifengtou.com/web/weiphp/Public/static/jquery-1.10.2.min.js"></script>
<![endif]-->
<!---蓝锂002适配修改 QQ:125682133--->
<!--[if gte IE 9]><!-->
<script type="text/javascript" src="/wap.weifengtou.com/web/weiphp/Public/static/jquery-2.0.3.min.js"></script>
<!--<![endif]-->
<script type="text/javascript" src="/wap.weifengtou.com/web/weiphp/Public/static/bootstrap/js/bootstrap.min.js"></script>
<script type="text/javascript" src="/wap.weifengtou.com/web/weiphp/Public/static/uploadify/jquery.uploadify.min.js"></script>
<script type="text/javascript" src="/wap.weifengtou.com/web/weiphp/Public/Home/js/dialog.js?v=<?php echo SITE_VERSION;?>"></script>
<script type="text/javascript" src="/wap.weifengtou.com/web/weiphp/Public/Home/js/admin_common.js?v=<?php echo SITE_VERSION;?>"></script>
<script type="text/javascript" src="/wap.weifengtou.com/web/weiphp/Public/Home/js/admin_image.js?v=<?php echo SITE_VERSION;?>"></script>
<script type="text/javascript">
var  STATIC = "/wap.weifengtou.com/web/weiphp/Public/static";
var  ROOT = "/wap.weifengtou.com/web/weiphp";
</script>
...
<section class="login_box">
	<form class="login-form" action="/wap.weifengtou.com/web/weiphp/index.php?s=/home/user/login.html" method="post">
...
(function(){
	var ThinkPHP = window.Think = {
		"ROOT"   : "/wap.weifengtou.com/web/weiphp", //当前网站地址
		"APP"    : "/wap.weifengtou.com/web/weiphp/index.php?s=", //当前项目地址
		"PUBLIC" : "/wap.weifengtou.com/web/weiphp/Public", //项目公共目录地址
